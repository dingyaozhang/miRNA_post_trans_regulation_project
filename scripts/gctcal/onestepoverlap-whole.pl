#perl scripts/gctcal/onestepoverlap-whole.pl -g gencode.v28.gtf -m hsa.gff3 -o result/overlap-whole.txt
use strict;
use warnings;
...
my @usemirna;
my @keysnorepeat = sort {$a cmp $b} keys(%norepeat);
for my $onekey (@keysnorepeat) {
